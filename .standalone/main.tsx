...
import PriorityRankReasons from "../app/priority-rank-reasons";
import "../app/priority-rank-reasons.css";
import "../app/priority-bridge.css";

createRoot(document.getElementById("root")!).render(<><Home /><PriorityBridge /><LeafletMapBridge /><ScoreGuideBridge /><PriorityRankReasons /><DataSources /><LiveWeatherRibbon /></>);
